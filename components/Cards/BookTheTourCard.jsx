...
export const BookTheTourCard = () => {
  ...
  return (
    <div className="min-w-[481px] max-w-[481px] bg-[#EDEDED] p-[40px] lg:max-w-full sm:p-[10px] sm:min-w-0">
      <h2 className="text-[42px] font-bold text-center sm:text-[26px]">Book This Tour</h2>
      ...
      <form className="flex flex-col gap-[9px]">
        <label className="relative">
          <input
            ...
            name="name"
            placeholder="Name"
            className="w-full pl-[55px] py-[25px] placeholder:font-poppins placeholder:text-[18px]"
            required
          />
        </label>
        <label className="relative">
        ...
        <label className="relative">
          <input
            ...
            className={`w-full pl-[55px] py-[25px] ${
